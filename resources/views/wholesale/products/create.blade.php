...
<div class="page-content mx-0">
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">{{ translate('Add New Produto Grossista') }}</h1>
            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small class="text-muted">{{ translate("Legacy unit field (text)") }}: 
                                        <input type="text" class="form-control mt-2" name="unit" placeholder="{{ translate("Unit (e.g. KG, Pc etc)") }}">
                                    </small>
                                </div>
                            </div>
                            <div class="form-group row">
