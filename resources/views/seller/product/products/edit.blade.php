            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control aiz-selectpicker" name="unit_id" data-live-search="true" required>
                            ...
                            <small class="text-muted">{{ translate('Legacy unit field (text)') }}: <input type="text" class="form-control mt-2" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}" value="{{$product->getTranslation('unit', $lang)}}"></small>
                        </div>
                    </div>
                    </div>
                    <div class="form-group row">
