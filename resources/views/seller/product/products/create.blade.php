                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small class="text-muted">{{ translate('Legacy unit field (text)') }}: <input type="text" class="form-control mt-2" name="unit" placeholder="{{ translate('Unit (e.g. KG, Pc etc)') }}"></small>
                                </div>
                            </div>
                            </div>
                            <div class="form-group row">
