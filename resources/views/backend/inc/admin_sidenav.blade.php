            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Produtos Grossista')}}</span>
                        @if (env("DEMO_MODE") == "On")
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14.001" viewBox="0 0 16 14.001"
                            class="mx-2">
                            <path id="Union_49" data-name="Union 49"
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{route('wholesale_product_create.admin')}}">
                                <span class="aiz-side-nav-text">{{translate('Add New Produto Grossista')}}</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('wholesale_products.all')}}"
                                ...
                                <span class="aiz-side-nav-text">{{ translate('All Produtos Grossista') }}</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('wholesale_products.in_house')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['wholesale_product_edit.admin']) }}">
                                <span class="aiz-side-nav-text">{{ translate('In House Produtos Grossista') }}</span>
                            </a>
                        </li>
                        @endcan
                        @if (get_setting('vendor_system_activation') == 1)
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('wholesale_products.seller')}}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['wholesale_product_edit.admin']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Seller Produtos Grossista') }}</span>
                            </a>
                        </li>
                        @endcan
                        @endif
