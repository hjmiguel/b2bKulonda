...
return [
    ...
    | usadas pela classe validadora. Algumas destas regras têm múltiplas
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar nosso placeholder
    | de atributo por algo mais amigável ao leitor, como "Endereço de Email"
