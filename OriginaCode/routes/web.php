...
// RPA Excel Upload Routes
Route::middleware(['auth'])->prefix('rpa')->name('rpa.')->group(function () {
    Route::get('/', [App\Http\Controllers\RPAExcelController::class, 'index'])->name('index');
    Route::post('/upload', [App\Http\Controllers\RPAExcelController::class, 'upload'])->name('upload');
    Route::get('/download/{filename}', [App\Http\Controllers\RPAExcelController::class, 'download'])->name('download');
    Route::delete('/delete/{filename}', [App\Http\Controllers\RPAExcelController::class, 'delete'])->name('delete');
});
