...
// ========================================
Route::get("/proxypay/reference/{referenceId}", "App\\Http\\Controllers\\ProxyPayController@show")->name("proxypay.show");
Route::get("/proxypay/check/{referenceId}", "App\\Http\\Controllers\\ProxyPayController@checkPayment")->name("proxypay.check");
Route::post("/webhook/proxypay", "App\\Http\\Controllers\\ProxyPayController@webhook")->name("proxypay.webhook");

// Rotas de exemplo para success/expired (adaptar ao seu projeto)
Route::get("/proxypay/success/{referenceId}", "App\\Http\\Controllers\\ProxyPayController@success")->name("payment.success");
Route::get("/proxypay/expired/{referenceId}", "App\\Http\\Controllers\\ProxyPayController@expired")->name("payment.expired");
