<?php
// Script para popular unidades HORECA
...
$units = [
    ...
    [
        'id' => 1, 'name' => 'Unidade', 'symbol' => 'Un', 'type' => 'count',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 1,
        'translations' => [
    ...
    [
        'id' => 2, 'name' => 'Caixa', 'symbol' => 'Cx', 'type' => 'count',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 2,
        'translations' => [
    ...
    [
        'id' => 3, 'name' => 'Pacote', 'symbol' => 'Pct', 'type' => 'count',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 3,
        'translations' => [
    ...
    [
        'id' => 4, 'name' => 'Fardo', 'symbol' => 'Fd', 'type' => 'count',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 4,
        'translations' => [
    ...
    [
        'id' => 5, 'name' => 'Engradado', 'symbol' => 'Eng', 'type' => 'count',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 5,
        'translations' => [
    ...
    [
        'id' => 6, 'name' => 'Palete', 'symbol' => 'Pallet', 'type' => 'count',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 6,
        'translations' => [
    ...
    [
        'id' => 7, 'name' => 'Dúzia', 'symbol' => 'Dz', 'type' => 'count',
        'base_conversion_factor' => 12.0000, 'is_active' => true, 'sort_order' => 7,
        'translations' => [
    ...
    // Unidades de Peso
    [
        'id' => 8, 'name' => 'Quilograma', 'symbol' => 'Kg', 'type' => 'weight',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 10,
        'translations' => [
    ...
    [
        'id' => 9, 'name' => 'Grama', 'symbol' => 'g', 'type' => 'weight',
        'base_conversion_factor' => 0.0010, 'is_active' => true, 'sort_order' => 11,
        'translations' => [
    ...
    [
        'id' => 10, 'name' => 'Tonelada', 'symbol' => 'Ton', 'type' => 'weight',
        'base_conversion_factor' => 1000.0000, 'is_active' => true, 'sort_order' => 12,
        'translations' => [
    ...
    // Unidades de Volume
    [
        'id' => 11, 'name' => 'Litro', 'symbol' => 'L', 'type' => 'volume',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 20,
        'translations' => [
    ...
    [
        'id' => 12, 'name' => 'Mililitro', 'symbol' => 'ml', 'type' => 'volume',
        'base_conversion_factor' => 0.0010, 'is_active' => true, 'sort_order' => 21,
        'translations' => [
    ...
    [
        'id' => 13, 'name' => 'Garrafa', 'symbol' => 'Gf', 'type' => 'volume',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 22,
        'translations' => [
    ...
    [
        'id' => 14, 'name' => 'Barril', 'symbol' => 'Barril', 'type' => 'volume',
        'base_conversion_factor' => 50.0000, 'is_active' => true, 'sort_order' => 23,
        'translations' => [
    ...
    // Unidades Mistas
    [
        'id' => 15, 'name' => 'Quilos por Caixa', 'symbol' => 'Kg/Cx', 'type' => 'mixed',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 30,
        'translations' => [
    ...
    [
        'id' => 16, 'name' => 'Unidades por Caixa', 'symbol' => 'Un/Cx', 'type' => 'mixed',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 31,
        'translations' => [
    ...
    [
        'id' => 17, 'name' => 'Litros por Caixa', 'symbol' => 'L/Cx', 'type' => 'mixed',
        'base_conversion_factor' => 1.0000, 'is_active' => true, 'sort_order' => 32,
        'translations' => [
...
echo "Inserindo unidades HORECA...\n";
...
foreach ($units as $unitData) {
    ...
    echo "  ✓ Unidade: {$unitData['name']} ({$unitData['symbol']})\n";
...
echo "\n✓ Total: " . count($units) . " unidades HORECA criadas com sucesso!\n";
